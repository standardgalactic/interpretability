...
- **Texture-nodes** carry values and modulate behavior within an existing regime.
- **Event-nodes** select regimes and impose irreversible constraints on future possibilities.
- True mechanistic understanding is **historical**: it explains what a system can no longer do as a result of its past.

This perspective resolves puzzles in mechanistic interpretability such as substitution failure, algorithmic mixture, grokking, and sudden circuit emergence, while also generalizing beyond neural networks to knowledge systems and institutions.
...
> Mechanistic understanding is not the inspection of a static system.  
> It is the causal reconstruction of the irreversible constraints that shape what the system can still become.

This repository treats interpretability as a form of **event-historical causal reverse engineering**, applicable to neural networks, training dynamics, and large-scale social knowledge systems alike.
